...
Third-party licenses are aggregated in `licenses.csv` generated by `licenses.py`.

What does this mean for you?
- **Personal use** (aka for you or anything that isn't public or don't generate revenue) - You can use it however you like, if you share, link to this repository or a mention would be nice
